...
<div class="main-slider">
    <?php foreach($arResult["ITEMS"] as $arItem): ?>
        <div class="slide">
            <div class="h2 main-slider__title"><?=$arItem['PROPERTIES']['UF_SLIDER_TITLE']['VALUE'];?></div>
            <a class="btn btn--transp" href="<?=$arItem['PROPERTIES']['UF_SLIDER_URL']['VALUE'];?>">
                <img class="svg btn__ic ic-arrow" src="<?=SITE_TEMPLATE_PATH?>/img/icons/ic-arrow.svg" alt="link" width="20" height="20">
                Подробнее
            </a>
        </div>
    <?php endforeach; ?>
