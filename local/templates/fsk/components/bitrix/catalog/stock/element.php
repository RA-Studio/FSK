    ...
    <div class="container">
		...
		if ($elementId > 0)
		{
			...
			if (!empty($recommendedData))
			{
						...
						<div class='col-xs-12' data-entity="parent-container">
							...
							$APPLICATION->IncludeComponent(
								...
								array(
									...
									'LINE_ELEMENT_COUNT' => 1,// $arParams['ALSO_BUY_ELEMENT_COUNT'],
									'TEMPLATE_THEME' => (isset($arParams['TEMPLATE_THEME']) ? $arParams['TEMPLATE_THEME'] : ''),
									'SHOW_OLD_PRICE' => $arParams['SHOW_OLD_PRICE'],
									'SHOW_DISCOUNT_PERCENT' => $arParams['SHOW_DISCOUNT_PERCENT'],
				...
				{
					?><div class="section-margin" data-entity="parent-container">
                        <h2 class="h1 title title-margin" data-entity="header" data-showed="false" style="display: none; opacity: 0;">
