...
<div class="page page-project<?=" $typeOfApartment"?>">
    ...
    <? if ($userProps['UF_PROJECT_NAME']['~VALUE']['TEXT']) : ?>
        <div class="project-about scrollspy-item" id="p-1">
            <div class="container">
                ...
                <? if (!empty($features)): ?>
                    <div class="project-data parking-project-data">
    ...
    <? endif; ?>
        <?include($_SERVER['DOCUMENT_ROOT']."$templateFolder/include/section/gallery.php")?>
        <div class="container section-margin scrollspy-item container__relative" id="p-6">
            <h2 class="h1 title" id="filter-anchor">Выбор машиномест</h2>
...
<?include($_SERVER['DOCUMENT_ROOT']."$templateFolder/include/section/parkingModal.php")?>
