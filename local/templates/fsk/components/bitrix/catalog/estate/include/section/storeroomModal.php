    ...
    <div class="p-relative">
        ...
        <div class="card__body js-tab-wrapper">
            <div class="card__col-1">
                <div class="card__tabs-wrap">
                    <div class="card__tabs js-tabs" style="justify-content: end;">
                        <button class="js-tab" type="button" style="display: none">Планировка</button>
                        <button style="margin: 0 20px" class="js-tab js-tab--active" type="button">На этаже</button>
                        <button style="margin: 0 20px" class="js-tab" type="button">Схема корпусов</button>
                    </div>
                </div>
                <div class="tooltip">
            ...
            <div class="card__col-2">
                <div class="card__img js-tab-item" style="display: none">
                ...
                <div class="card__img js-tab-item" style="min-height: 333px;display: block;">
                    <div class="card-img-btns">
                        <button class="ui-btn zoom-link" href="img/img-plan-big.jpg">
                            <img class="svg lazyload" data-src="<?=SITE_TEMPLATE_PATH?>/img/icons/ic-zoom.svg" width="15" height="15" alt="zoom">
                        </button>
                    ...
                    <div class="card-data">
                        <div class="card-data__col-1">
                            ...
                            <ul class="card-data__list">
                                ...
                                <li style="display:none;"><span>Этаж / этажей</span><span>8/26</span></li>
