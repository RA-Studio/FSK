...
?><div class="p-item__img">
    ...
    <?if(!empty($item['PREVIEW_PICTURE']['SRC'])){?>
            <?$img = \CFile::ResizeImageGet($preview, array('width'=>500, 'height'=>240), BX_RESIZE_IMAGE_EXACT, true)['src']?>
        <img alt="<?=$item['PREVIEW_PICTURE']['ALT']?>" data-src="<?=$img?>" class="img lazyload"><?
    }
    ?></a><?
