 ...
 */
    ...
    $parent = CIBlockSection::GetNavChain(false,$item['IBLOCK_SECTION_ID'])->GetNext();
$globalSetting = RaStudio\Ajax\AjaxFilter::globalSetting();
?>
<div class="favourite-item__img">
    <?if(!empty($item['PROPERTIES']['image']['VALUE'])){?>
        <?//foreach ($item['PROPERTIES']['image']['VALUE'] as $key=>$value){?>
            <img alt="<?=$item['PROPERTIES']['image']['DESCRIPTION'][0]?>" src="<?=CFile::GetPath($item['PROPERTIES']['image']['VALUE'][0])?>" class="img">
        <?//}?>

    <?}else{?>
        <img class="img img-empty">
    <?}?>
    <button class="results-offer__modal js-call-card" type="button">
        <img width="37" alt="flat plan" src="/local/templates/fsk/img/icons/ic-flat-plan.svg" height="37" class="svg">
    </button>
</div>
        ...
        <div class="data-row flex">
            <div class="data-col">
                ...
                <div class="data-value">
                    <?=$item['PROPERTIES']['area']['VALUE']?> м<sup>2</sup>
                </div>
            </div>
            <div class="data-col">
                <div class="data-label">
            ...
            <div class="data-col">
                ...
                <div class="data-value">
                    <?=$item['PROPERTIES']['builtyear']['VALUE']?>
                </div>
            </div>
            <div class="data-col data-price">
                ...
                <div class="data-value">
                    <?if($globalSetting['show_price']['VALUE_XML_ID'] != "show"):?>
                        <span class="dashed-underline">По запросу</span>
                    <?else:?>
                        <?=CurrencyFormat($item['PROPERTIES']['price100']['VALUE'], "RUB");?>
                    <?endif?>
                </div>
            </div>
        </div>
        <div class="data-col data-object">
            <div class="data-label">
                Объект:
            </div>
            <div class="data-value">
                <a href="<?=$parent['SECTION_PAGE_URL']?>"><?=$parent['NAME']?></a>
            </div>
        </div>
    </div>
    <?if(OPEN_SHOP):?>
