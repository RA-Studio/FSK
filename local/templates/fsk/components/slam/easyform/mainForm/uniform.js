...
$(document).on('blur', 'input.general-itemInput__input:not(input[data-type="tel"]):not(input[data-type="email"]), textarea', function(){
...
$(document).on('blur', 'input.general-itemInput__input, textarea', function(){
  if($(this).val() != ''){
