<template>
    <div class="content">
        ...
        <div class="info">
            <div class="container">
                <h2 class="h1 title">Оформление заявления на УКЭП</h2>
                <div class="info-greytext">
                    ...
                    Усиленная квалифицированная подпись (УКЭП) — это электронный аналог собственноручной подписи, полностью защищенной специальными протоколами безопасности.
                </div>
                <div class="info-withside">
                    ...
                    <div class="info-withside-side">
                        <div class="info-withside-side-load" v-if="filesLoad.length === 0">
                            ...
                            Ваше заявление скоро сформируется. Ожидайте...
                        </div>
        ...
        methods: {
            fileUserAdd(iterator, info) {
                ...
                this.$set(this.users, iterator, {
                    files: {
                        ukep: { type: 'file', lable: `Скан заявления на УКЭП (${nameFromFile})`, class: '', files: {} },
                    },
                });
            },
            collectBlockFile() {
