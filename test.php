...
<div class="print">
    <div class="container">
        <div class="print-pdf">
            <div class="print-hero"><img class="img print-hero__img" src="<?=SITE_TEMPLATE_PATH?>/img/img-docs-1.jpg" alt="alt">
                <div class="print-center">
                    <div class="print-header">
                        <h1 class="h1 p-hero__title">UP-квартал "Пушкинский"</h1><img class="img print-header__el" src="<?=SITE_TEMPLATE_PATH?>/img/print-hero-el.png" alt="alt">
                        <div class="print-data flex">
                            ...
                            <div class="p-distance flex"><img class="img" src="<?=SITE_TEMPLATE_PATH?>/img/icons/ic-walk-dist.svg" width="8" height="13" alt="alt"><span>
                    5 минут</span></div>
                        </div>
                        <div class="p-discount flex">
                            <div class="p-discount__ic">%</div>
                            <p class="p-discount__txt">Супер акция! Три строчки уточняющего текста с подробными условиями</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content-margin">
                        ...
                        <div class="f-row print-row">
                            ...
                            <div class="cols col-1-3 print-col">
                                <p class="print-info accent-color">Цена по акции: <span>7 200 360</span> р.</p>
                                <p class="print-info">Стандартная цена: <span>7 900 360</span> р.</p>
                                <p class="print-info sub-color">ID квартиры: <span>45 702</span></p>
                            </div>
                        </div>
                        <div class="print-table">
                            <div class="print-img print-img-1"><img class="img" src="<?=SITE_TEMPLATE_PATH?>/img/img-plan-big.jpg" alt="alt"></div>
                            <div>
                                <div class="print-img print-img-2"><img class="img" src="<?=SITE_TEMPLATE_PATH?>/img/img-plan-2.jpg" alt="alt"></div>
                                <div class="print-img print-img-3"><img class="img" src="<?=SITE_TEMPLATE_PATH?>/img/img-plan-3.jpg" alt="alt"></div>
                            </div>
                        </div>
                    </div>
                </div>
